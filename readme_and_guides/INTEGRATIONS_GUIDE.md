...
- **Implementation**: [integrations/codebeamer_sync.py](../integrations/codebeamer_sync.py)
...
- **Implementation**: [integrations/jira_sync.py](../integrations/jira_sync.py)
...
- **Implementation**: [integrations/email_notify.py](../integrations/email_notify.py)
...
- **Implementation**: [integrations/teams_notify.py](../integrations/teams_notify.py)
...
- **GitHub / GitLab**: Commit frequency, PR cycle time, code review velocity ([integrations/github_sync.py](../integrations/github_sync.py))
- **Slack**: Incident alerts and channel notifications ([integrations/slack_notify.py](../integrations/slack_notify.py))
- **Outlook Calendar**: Milestone deadline sync ([integrations/outlook_calendar_sync.py](../integrations/outlook_calendar_sync.py))
